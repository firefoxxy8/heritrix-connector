...
import org.archive.modules.credential.BasicSecurityManager;

import com.searchtechnologies.aspire.framework.utilities.SecurityUtilities;

public class AspireSecurityManager implements BasicSecurityManager {

  @Override
  public String decryptString(String encryptedString) {
    try {
      return SecurityUtilities.decryptString(encryptedString);
    } catch (Exception e) {
      return null;
    }
  }
