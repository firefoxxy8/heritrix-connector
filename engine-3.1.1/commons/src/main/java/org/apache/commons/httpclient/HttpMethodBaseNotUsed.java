...
public abstract class HttpMethodBaseNotUsed implements HttpMethod {

    // -------------------------------------------------------------- Constants

    /** Log object for this class. */
    private static final Log LOG = LogFactory.getLog(HttpMethodBaseNotUsed.class);
    ...
    * a recoverable exception. */
     ...
     */
    public HttpMethodBaseNotUsed(String uri) 
...
//      END IA/HERITRIX CHANGES
    ...
    private String getRequestLine(HttpConnection conn) {
        return  HttpMethodBaseNotUsed.generateRequestLine(conn, getName(),
