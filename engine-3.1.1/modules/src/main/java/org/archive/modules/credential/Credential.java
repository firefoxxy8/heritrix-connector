...
public abstract class Credential implements Serializable {
    ...
    protected Date sessionStartTime = null;
    long expireAfter = -1;
    public int getExpireAfter() {
        if (expireAfter == -1)
            return -1;
        return (int)expireAfter/1000;
    }
    public void setExpireAfter(int seconds) {
        expireAfter = seconds*1000;
    }
    
    public boolean isExpired() {
        if (sessionStartTime == null || expireAfter == -1)
            return false;
        
        long afterSessionCreated = (new Date().getTime() - sessionStartTime.getTime());
        
        return afterSessionCreated > expireAfter; 
    }
...
//            getName();
    ...
    String expiredContent = null;
    public void setExpiredContent(String content) {
