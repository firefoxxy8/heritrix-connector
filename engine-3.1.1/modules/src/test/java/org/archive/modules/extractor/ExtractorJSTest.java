...
public class ExtractorJSTest extends StringExtractorTestBase {
    ...
    // Kludge to make the test pass on Windows
    private static final boolean isWindows = System.getProperty("os.name", "unknown").toLowerCase().startsWith("windows");
    private static String addSlashOnWindows() {
      return isWindows ? "/" : "";
    }
    ...
    final public static String[] VALID_TEST_DATA = new String[] {
        ...
        "http://www.example.com/outlink" + addSlashOnWindows(),
